...
export default function DashboardPage() {
  ...
  return (
    <main className="min-h-screen p-6 max-w-md mx-auto flex flex-col bg-[#FDF6EC]">
      ...
      {/* Pulsanti Header Funzionanti */}
      <div className="grid grid-cols-3 gap-4 mb-12 px-4">
        <Link href="/dashboard/log" className="flex flex-col items-center gap-2 hover:scale-105 transition-transform">
        ...
        <Link href="/dashboard/contacts" className="flex flex-col items-center gap-2 hover:scale-105 transition-transform">
          <div className="w-16 h-16 bg-white border-[3px] border-black rounded-2xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] flex items-center justify-center text-2xl">📞</div>
          <span className="font-patrick text-xs font-bold uppercase text-black">Contatti</span>
        </Link>
        
        <Link href="/dashboard/help" className="flex flex-col items-center gap-2 hover:scale-105 transition-transform">
          <div className="w-16 h-16 bg-white border-[3px] border-black rounded-2xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] flex items-center justify-center text-2xl">📧</div>
            ...
            <div key={pet.id} className="flex-[0_0_85%] min-w-0 pl-4 pb-4">
              <div className="slurpy-card flex flex-col items-center p-6 relative h-full">
                ...
                <div className="flex flex-col gap-3 w-full">
                  {/* Tasto Gestisci Profilo - Punta alla pagina di gestione del singolo cane */}
                  <Link 
                  ...
                  {/* Area Stato NFC - Punta alla pagina di connessione NFC del cane */}
